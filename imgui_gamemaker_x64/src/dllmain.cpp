...
fn_export double imgui_style_set_tab_min_width_for_close_button(double width) {
	ImGui::GetStyle().TabMinWidthForCloseButton = width;
	return 0.0;
}

fn_export double imgui_style_get_tab_min_width_for_close_button() {
...
fn_export double imgui_style_set_circle_tessellation_max_error(double max_error) {
	ImGui::GetStyle().CircleTessellationMaxError = max_error;
	return 0.0;
}

fn_export double imgui_style_get_circle_tessellation_max_error() {
